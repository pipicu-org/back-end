...
export class MigrationV31756667980440 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Line" ("id" SERIAL NOT NULL, "quantity" numeric(10,2) NOT NULL, "totalPrice" numeric(10,2) NOT NULL, "addedAt" TIMESTAMP NOT NULL DEFAULT now(), "orderId" integer, "productId" integer, CONSTRAINT "PK_29cb58c6844e6c7387e66d7ac5e" PRIMARY KEY ("id"))`);
