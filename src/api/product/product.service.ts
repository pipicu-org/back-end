export interface IProductService {
  getByName(name: string, page: number, limit: number): Promise<import('../models/DTO/response/productSearchResponseDTO').ProductSearchResponseDTO>;
  getProductById(id: number): Promise<import('../models/DTO/response/productResponseDTO').ProductResponseDTO>;
  createProduct(product: import('../models/DTO/request/productRequestDTO').ProductRequestDTO): Promise<import('../models/DTO/response/productResponseDTO').ProductResponseDTO>;
