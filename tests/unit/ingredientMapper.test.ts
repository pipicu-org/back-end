...
describe('IngredientMapper', () => {
  ...
  describe('requestDTOToEntity', () => {
    it('should create ingredient entity from request DTO', () => {
      const requestDTO: IngredientRequestDTO = { name: 'Tomato', price: 2.5 };
      ...
      expect(result.price).toBe(requestDTO.price);
    });
  });

  describe('toEntity', () => {
    it('should create ingredient entity from response DTO', () => {
      const responseDTO: IngredientResponseDTO = { id: 1, name: 'Tomato', price: 2.5 };
      ...
      expect(result.price).toBe(responseDTO.price);
    });
  });

  describe('toResponseDTO', () => {
    it('should map ingredient entity to response DTO', () => {
      const ingredient: Ingredient = { id: 1, name: 'Tomato', price: 2.5 } as Ingredient;
      ...
      expect(result.price).toBe(ingredient.price);
    });
  });

  describe('createSearchToIngredientSearchDTO', () => {
    it('should create search response DTO', () => {
      const ingredients: Ingredient[] = [{ id: 1, name: 'Tomato', price: 2.5 } as Ingredient];
      const search = 'Tom';
      const page = 1;
      const limit = 10;
      const total = 1;
      ...
      expect(result.data[0].price).toBe(ingredients[0].price);
    });
  });
});